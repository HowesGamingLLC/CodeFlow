...
export function Build() {
  ...
  const startBuild = () => {
    ...
    setBuildSteps(steps => steps.map(step => ({ ...step, status: 'pending' as const })));
      ...
      <div className="p-4 border-b border-gray-700 bg-gray-800">
        ...
        <div className="flex gap-2">
          ...
          <Button
            size="sm"
            variant="outline"
            onClick={() => setBuildSteps(steps => steps.map(step => ({ ...step, status: 'pending' as const })))}
      ...
      <ScrollArea className="flex-1">
        <div className="p-4">
          <div className="space-y-3">
            <h3 className="text-sm font-medium text-gray-300 mb-3">Build Pipeline</h3>
          ...
          <div className="mt-6">
            ...
            <Card className="bg-gray-800 border-gray-700">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm text-gray-200">Build Settings</CardTitle>
