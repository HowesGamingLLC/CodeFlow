    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            What each role can do in your team
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm">
              <div className="font-medium text-gray-900 dark:text-white">Permission</div>
            ...
            {[
              ...
              <div key={permission} className="grid grid-cols-1 md:grid-cols-4 gap-4 py-2 border-b border-gray-100 dark:border-gray-800 text-sm">
                <div className="text-gray-700 dark:text-gray-300">{permission}</div>
                <div className="text-center">
                  <CheckCircle className="w-4 h-4 text-green-500 mx-auto" />
                </div>
                <div className="text-center">
                  {['Create sites', 'Deploy sites', 'Manage domains', 'Invite members'].includes(permission) ? (
                    <CheckCircle className="w-4 h-4 text-green-500 mx-auto" />
                  ) : (
