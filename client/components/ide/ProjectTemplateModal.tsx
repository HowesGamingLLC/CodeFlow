...
export function ProjectTemplateModal({ open, onClose }: ProjectTemplateModalProps) {
  const [selectedTemplate, setSelectedTemplate] = useState<string>('vanilla-js');
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl bg-gray-900 border-gray-700 text-gray-200">
        <DialogHeader>
          <DialogTitle className="text-xl text-gray-200">Create New Project</DialogTitle>
        </DialogHeader>
        
        <div className="grid grid-cols-2 gap-6">
          {/* Templates */}
          <div>
            <h3 className="text-sm font-medium text-gray-300 mb-4">Choose a Template</h3>
                    ...
                    <CardHeader className="pb-3">
                      <div className="flex items-start justify-between">
                        <div className="flex items-center gap-3">
                          <div className={`w-10 h-10 rounded-lg bg-gray-700 flex items-center justify-center ${getIconColor(template.language)}`}>
          ...
          <div>
                ...
                <div className="mt-6 p-4 bg-gray-800 rounded-lg border border-gray-700">
                  ...
                  <div className="space-y-2">
                    <div className="text-xs text-gray-300">
                      <span className="font-medium">Language:</span> {selectedTemplateData.language}
                    </div>
                    <div className="text-xs text-gray-300">
            ...
            <div className="flex gap-3 mt-6">
              <Button
                ...
                disabled={!projectName.trim() || !selectedTemplateData || selectedTemplateData.comingSoon}
